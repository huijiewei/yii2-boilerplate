                ...
                'children' => [
                    [
                        'children' => [
                            [
                                'name' => '商品列表',
                                'actionId' => 'shop-product/index'
                            ],
                            [
                                'name' => '商品导出',
                                'actionId' => 'shop-product/export',
                            ],
                            [
                                'name' => '商品新建',
                            ...
                            [
                                'name' => '商品删除',
                                'actionId' => 'shop-product/delete'
                            ],
                            [
                                'name' => '商品导入',
                                'actionId' => 'shop-product/import',
                            ],
                        ]
                    ],
                    [
        ...
        return [
            ...
            [
                ...
                'children' => [
                    [
                        'label' => '跳转登录',
                        'url' => 'test/login-direct'
                    ],
                    [
                        'label' => '登录模态框',
                        'url' => 'test/login-modal'
                    ],
                    [
                        'label' => '没有权限',
                        'url' => 'test/service-void'
                    ],
                    [
                        'label' => '服务未实现',
                        'url' => 'test/service-void'
